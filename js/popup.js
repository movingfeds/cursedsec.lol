...
function popup1() {
    CreativaPopup.create('Feel free to DM me fakechaos', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('Feel free to DM me <font class="contactding" onclick="allahm109kd();" color="#FF0000">fakechaos</font><br> <font style="color: #696969; font-size: smaller;"> or my ig <a href="https://instagram.com/fakxhaos" style="color: #ADD8E6;">https://instagram.com/fakxhaos</a> </font>', 'Discord/Insta', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
}
...
function allahm109kd() {
    navigator.clipboard.writeText("fakechaos").then(function() {
...
function allahm109kd1() {
    navigator.clipboard.writeText("fakechaos");
    setTimeout(function() {
        alert("Discord username was copied to the clipboard");
    }, 50);
}
